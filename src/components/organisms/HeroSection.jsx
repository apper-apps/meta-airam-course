  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 hero-gradient">
        ...
        {/* Floating Elements */}
        <div className="absolute top-1/4 left-1/4 w-20 h-20 bg-primary-500/20 rounded-full animate-float" />
        <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-secondary-500/20 rounded-full animate-float" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-1/4 left-1/3 w-24 h-24 bg-accent-500/20 rounded-full animate-float" style={{ animationDelay: '2s' }} />
{/* Grid Pattern */}
      ...
      <div className="relative z-10 container-custom text-center">
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-gray-600 dark:text-gray-400 text-3xl md:text-4xl lg:text-5xl">
              in Just 2 Months
            </span>
          </motion.h1>
          ...
          >
            {[
              { number: '2', label: 'Months Duration', icon: 'Clock' },
              { number: '6+', label: 'AI Tools Covered', icon: 'Bot' },
              { number: '100%', label: 'Practical Learning', icon: 'Target' },
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
